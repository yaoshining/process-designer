 ...
 */
requirejs(["jquery","underscore","backbone","raphael","layout","jquery-ui"], function($) {
    var layout;
    ...
    $(document).ready(function(){
        ...
        var paper = new Raphael(center,$(center).innerWidth(),$(center).innerHeight());
        var circle = paper.circle(50,50,20);
        var rect = paper.rect(150,30,150,50,10);
        rect.attr({
            "fill": "yellow",
            "stroke": "yellow",
            title: "Rect"
